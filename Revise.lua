        ...
        for _, layout in pairs(CellDB["layouts"]) do
            ...
            if layout["indicators"][4] and layout["indicators"][4]["indicatorName"] == "roleIcon" then
                if type(layout["indicators"][4]["customTextures"]) ~= "table" then
                    layout["indicators"][4]["customTextures"] = {false, "Interface\\AddOns\\Cell_Ascension\\Media\\Roles\\Default_TANK.tga", "Interface\\AddOns\\Cell_Ascension\\Media\\Roles\\Default_HEALER.tga", "Interface\\AddOns\\Cell_Ascension\\Media\\Roles\\Default_DAMAGER.tga"}
                end
            end
        end
    end
