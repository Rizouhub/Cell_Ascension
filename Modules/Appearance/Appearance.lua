...
local function CreateCellPane()
    ...
    recScaleBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\resize", {15, 15}, {"CENTER", 0, 0})
    ...
    local scaleSliderText =  cellPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local accentColorText = cellPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreatePreviewIcons()
    ...
    local previewText = previewIconsBG:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_TITLE")
...
local function CreatePreviewButtons()
    ...
    local previewText2 = previewButtonBG2:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_TITLE")
...
local function CheckTextures()
    ...
    local defaultTexture, defaultTextureName = "Interface\\AddOns\\Cell_Ascension\\Media\\statusbar.tga", "Cell ".._G.DEFAULT
...
local function CreateIconOptionsFrame()
    ...
    local iconAnimationText = iconOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    -- duration decimal
    durationDecimalText1 = iconOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    durationDecimalText2 = iconOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    durationSecondText = iconOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateUnitButtonStylePane()
    ...
    local textureText = unitButtonPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local barColorText = unitButtonPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local lossColorText = unitButtonPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local powerColorText = unitButtonPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local barAnimationText = unitButtonPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    resetBtn:SetScript("OnClick", function()
        if IsControlKeyDown() then
            ...
            -- load data
            textureDropdown:SetSelected("Cell ".._G.DEFAULT, "Interface\\AddOns\\Cell_Ascension\\Media\\statusbar.tga")
            LoadButtonStyle()
...
local function CreateDebuffTypeColorPane()
    ...
    -- curse
    curseCP = Cell.CreateColorPicker(dtcPane, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Curse:0|t"..L["Curse"], false, nil, function(r, g, b)
    ...
    -- disease
    diseaseCP = Cell.CreateColorPicker(dtcPane, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Disease:0|t"..L["Disease"], false, nil, function(r, g, b)
    ...
    -- magic
    magicCP = Cell.CreateColorPicker(dtcPane, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Magic:0|t"..L["Magic"], false, nil, function(r, g, b)
    ...
    -- poison
    poisonCP = Cell.CreateColorPicker(dtcPane, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Poison:0|t"..L["Poison"], false, nil, function(r, g, b)
    ...
    -- bleed
    bleedCP = Cell.CreateColorPicker(dtcPane, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Bleed:0|t"..L["Bleed"], false, nil, function(r, g, b)
