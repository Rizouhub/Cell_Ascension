...
local function CreateDebuffsImportExportFrame()
    ...
    -- instance name
    instance = importExportFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
    instance:SetPoint("TOPLEFT", title, "BOTTOMLEFT", 0, -5)

    -- boss name
    boss = importExportFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
