...
local function CreateWidgets()
    ...
    helpBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\info2.tga", {16, 16}, {"CENTER", 0, 0})
    helpBtn:SetPoint("TOPRIGHT", -5, -7)
    Cell.Polyfill.HookScript(helpBtn, "OnEnter", function()
    ...
    Cell.Polyfill.HookScript(helpBtn, "OnLeave", function()
        CellTooltip:Hide()
    end)
    ...
    exportBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\export.blp", {16, 16}, {"CENTER", 0, 0})
    ...
    importBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\import.blp", {16, 16}, {"CENTER", 0, 0})
...
local function CreateInstanceFrame()
    ...
    local instanceNameText = imageFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateBossesFrame()
    ...
    local bossNameText = imageFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateDebuffsFrame()
    ...
    -- text
    dragged.text = dragged:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateDetailsFrame()
    ...
    -- spell name & id
    spellNameText = detailsContentFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    spellIdText = detailsContentFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    -- condition
    --------------------------------------------------
    local conditionText = detailsContentFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    -- glow
    --------------------------------------------------
    glowTypeText = detailsContentFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    -- glowCondition
    local glowConditionText = glowOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
-- local descText = detailsContentFrame.scrollFrame.content:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
