...
local function CreatePreviewButton()
    ...
    local previewText = previewButtonBG:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS_TITLE")
...
local function CreateSyncPane()
    ...
    syncTip.tex:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\info2.tga")
    ...
    syncStatus.title = syncStatus:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS_TITLE")
    syncStatus.title:SetText(L["Sync Status"])
    syncStatus.title:SetPoint("BOTTOMLEFT", syncStatus, "TOPLEFT", 5, -18)

    syncStatus.text = syncStatus:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateListPane()
    ...
    createBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {16, 16}, {"CENTER", 0, 0})
    ...
    importBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\import", {16, 16}, {"TOPLEFT", 14, -2})
    ...
    exportBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\export", {16, 16}, {"TOPLEFT", 14, -2})
    ...
    copyBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\copy", {16, 16}, {"TOPLEFT", 14, -2})
...
LoadIndicatorList = function()
    ...
    for i, t in pairs(currentLayoutTable["indicators"]) do
        ...
        if t["type"] == "built-in" then
            ...
            b.typeIcon:Show()
            b.typeIcon:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Indicators\\indicator-"..t["type"])
