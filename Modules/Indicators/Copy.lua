...
local function CreateIndicatorsCopyFrame()
    ...
    local fromText = copyFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
    fromText:SetPoint("BOTTOMLEFT", fromDropdown, "TOPLEFT", 0, 1)
    fromText:SetText(L["From"])

    local toText = copyFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
