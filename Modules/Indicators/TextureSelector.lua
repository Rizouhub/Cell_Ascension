...
local function CreateTextureSelector()
    ...
    addEB.tip = addEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    -- current path
    currentTexturePath = textureSelector:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
