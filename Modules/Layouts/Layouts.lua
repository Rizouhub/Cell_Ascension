...
local function CreatePreviewButton()
    ...
    local previewText = previewButtonBG:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_TITLE")
...
local function CreateLayoutPreview()
    ...
    layoutPreviewName = layoutPreviewAnchor:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS_TITLE")
    ...
    for i = 1, 8 do
        ...
        for j = 1, 5 do
            ...
            header[j].label = header:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_SMALL")
    ...
    for i = 1, 40 do
        ...
        f.label = layoutPreview.combinedHeader:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_SMALL")
...
local function CreateLayoutPane()
    ...
    -- enabledLayoutText = layoutPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_TITLE")
    ...
    newBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {16, 16}, {"CENTER", 0, 0})
    ...
    importBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\import", {16, 16}, {"CENTER", 0, 0})
    ...
    exportBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\export", {16, 16}, {"CENTER", 0, 0})
    ...
    shareBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\share", {16, 16}, {"CENTER", 0, 0})
...
local function CreateAutoSwitchPane()
    ...
    currentProfileBox.text = currentProfileBox:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local currentProfileText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    soloText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    partyText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    raidOutdoorText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    if Cell.isRetail then
        ...
        raidInstanceText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        raidMythicText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    elseif Cell.isMists or Cell.isCata or Cell.isWrath then
        ...
        raid10Text = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        raid25Text = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    arenaText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    if Cell.isVanilla then
        ...
        bgText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        bg15Text = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        bg40Text = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateRoleOrderWidget(parent)
    ...
    for _, role in pairs({"TANK", "HEALER", "DAMAGER"}) do
        local button = Cell.CreateButton(frame, nil, "accent-hover", {20, 20})
        button:SetTexture(F.GetDefaultRoleIcon(role), {16, 16}, {"CENTER", 0, 0}, false, true)
        button._role = role
        ...
        button:SetScript("OnDragStop", function(self)
            ...
            C_Timer.After(0.05, function()
                local target = F.GetMouseFocus()
                if target ~= self and target and target._role then
    ...
    function frame:Load(order)
        for index, role in pairs(order) do
            local button = buttons[role]
            button:SetFrameStrata("DIALOG")
            button:Show()
            button:ClearAllPoints()
            button:SetPoint("TOPLEFT", (index-1)*(P.Scale(20)+P.Scale(3)), 0)
        end
    end
...
local function CreateLayoutSetupPane()
    ...
    local orientationText = orientationDropdown:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local anchorText = layoutSetupPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    sortByRoleCB = Cell.CreateCheckButton(pages.main, L["Sort By Role"], function(checked)
        ...
        Cell.Fire("UpdateLayout", selectedLayout, "sort")
    end, L["Sort By Role"], "|cffffb5c5"..L["Left-Drag"]..":|r "..L["change the order"])
    ...
    local spotlightOrientationText = spotlightOrientationDropdown:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
-- tips
-------------------------------------------------
local tips = layoutsTab:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
LoadLayoutAutoSwitchDB = function()
    ...
    elseif Cell.isCata or Cell.isWrath then
        ...
        if Cell.vars.activeTalentGroup == 1 then
            currentProfileBox.text:SetText("|TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\1:13|t "..L["Primary Talents"])
        else
            currentProfileBox.text:SetText("|TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\2:13|t "..L["Secondary Talents"])
        end
        raid10Dropdown:SetSelectedValue(Cell.vars.layoutAutoSwitch["raid10"])
        raid25Dropdown:SetSelectedValue(Cell.vars.layoutAutoSwitch["raid25"])
        bg15Dropdown:SetSelectedValue(Cell.vars.layoutAutoSwitch["battleground15"])
