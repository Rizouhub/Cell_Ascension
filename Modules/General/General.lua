...
local function CreateTooltipsPane()
    ...
    tooltipsAnchorText = tooltipsPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    tooltipsAnchoredToText = tooltipsPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreatePositionPane()
    ...
    local menuPositionText = positionPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateNicknamePane()
    ...
    nicknameEB.tip = nicknameEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateLibGetFramePane()
    ...
    local framePriorityText = miscPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
