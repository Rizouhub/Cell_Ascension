...
local function CreateCustomNicknamesFrame()
    ...
    newItem.playerName.tip = newItem.playerName:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    newItem.nickname.tip = newItem.nickname:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    newItem.tip = newItem:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    customs[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
...
LoadList = function()
    ...
    for i, v in ipairs(CellDB["nicknames"]["list"]) do
        if not customs[i] then
            ...
            -- playerName
            customs[i].playerName = customs[i]:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
            ...
            -- nickname
            customs[i].nickname = customs[i]:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
            ...
            -- customs[i].del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
            ...
            -- customs[i].edit:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\info", {16, 16}, {"CENTER", 0, 0})
