...
local function CreateImportConfirmationFrame()
    ...
    -- message
    local text1 = confirmationFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_TITLE")
    ...
    local text2 = confirmationFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local text3 = confirmationFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateImportExportFrame()
    ...
    -- close
    local closeBtn = Cell.CreateButton(importExportFrame, "X", "red", {18, 18}, false, false, "Cell_Ascension_FONT_WIDGET_TITLE", "Cell_Ascension_FONT_WIDGET_TITLE_DISABLE")
    ...
    -- title
    title = importExportFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
