...
local function CreateDescriptionPane()
    ...
    local descText = descriptionPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateSlashPane()
    ...
    local commandText = slashPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateAnimation(frame)
    ...
    Cell.Polyfill.SetFromAlpha(fadeOut.alpha, 1)
    Cell.Polyfill.SetToAlpha(fadeOut.alpha, 0)
    ...
    Cell.Polyfill.SetFromAlpha(fadeIn.alpha, 0)
    Cell.Polyfill.SetToAlpha(fadeIn.alpha, 1)
...
local function CreateButton(w, h, tex)
    ...
    Cell.Polyfill.HookScript(supportersBtn, "OnEnter", function()
        F.HideUtilityList()
    end)
...
local function CreateSupportersPane()
    ...
    heartIcon:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\sparkling_heart")
    ...
    Cell.Polyfill.SetGradient(bgTex, "HORIZONTAL", CreateColor(0.1, 0.1, 0.1, 1), CreateColor(0.1, 0.1, 0.1, 0.7))
...
local function CreateLinksPane()
    ...
    --! github
    local github = CreateLink(linksPane, "github", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\github.tga", function()
    ...
    --! curseforge
    local curseforge = CreateLink(linksPane, "curseforge", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\curseforge.tga", function()
    ...
    --! wago
    local wago = CreateLink(linksPane, "wago", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\wago.tga", function()
    ...
    --! discord
    local discord = CreateLink(linksPane, "discord", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\discord.tga", function()
    ...
    --! kook
    local kook = CreateLink(linksPane, "kook", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\kook.tga", function()
    ...
    --! nga
    local nga = CreateLink(linksPane, "nga", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\nga.tga", function()
    ...
    --! afdian
    local afdian = CreateLink(linksPane, "afdian", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\afdian.tga", function()
    ...
    --! ko-fi
    local kofi = CreateLink(linksPane, "kofi", "Interface\\AddOns\\Cell_Ascension\\Media\\Links\\ko-fi.tga", function()
...
local function CreateImportExportPane()
    ...
    importBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\import", {16, 16}, {"LEFT", 2, 0})
    ...
    exportBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\export", {16, 16}, {"LEFT", 2, 0})
    ...
    -- backupBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\backup", {16, 16}, {"LEFT", 2, 0})
end
