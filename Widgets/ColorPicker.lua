...
local function CreateEB(label, width, height, isNumeric, group)
    ...
    eb.label = eb:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateColorPicker()
    ...
    brightness.thumb2:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\thumb.tga")
    ...
    alpha.thumb2:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\thumb.tga")
