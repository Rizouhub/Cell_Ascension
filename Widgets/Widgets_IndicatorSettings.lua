...
local function CreateSetting_HealthFormat(parent)
    ...
    if not settingWidgets["healthFormat"] then
        ...
        local health1Text = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        widget.health2DelimiterText = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        local shieldText = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        widget.shieldDelimiterText = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        local healAbsorbText = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        widget.healAbsorbDelimiterText = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateSetting_ClassColor(parent)
    ...
    if not settingWidgets["classColor"] then
        ...
        local text = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateSetting_Duration(parent)
    ...
    if not settingWidgets["duration"] then
        ...
        -- duration decimal
        widget.durationDecimalText1 = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        widget.durationDecimalText2 = widget:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateSetting_RoleTexture(parent)
    ...
    if not settingWidgets["roleTexture"] then
        ...
        local ICON_PATH = " |TInterface\\AddOns\\Cell_Ascension\\Media\\Roles\\Preview_%s:0:4|t"
        local options = {
...
local function CreateAuraButtons(parent, auraButtons, auraTable, noUpDownButtons, isZeroValid, hasColorPicker, updateHeightFunc)
    ...
    if not auraButtons[0] then
        ...
        auraButtons[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
    ...
    for i, spell in ipairs(auraTable) do
        ...
        if not auraButtons[i] then
            ...
            auraButtons[i].del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
            ...
            -- auraButtons[i].edit:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\info", {16, 16}, {"CENTER", 0, 0})
            ...
            auraButtons[i].down:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\down", {16, 16}, {"CENTER", 0, 0})
            ...
            auraButtons[i].up:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\up", {16, 16}, {"CENTER", 0, 0})
...
local function CreateSetting_Auras(parent, index)
    ...
    if not auraImportExportFrame then
        ...
        auraImportExportFrame.closeBtn = Cell.CreateButton(auraImportExportFrame, "X", "red", {18, 18}, false, false, "Cell_Ascension_FONT_WIDGET_TITLE", "Cell_Ascension_FONT_WIDGET_TITLE_DISABLE")
    ...
    if not settingWidgets["auras"..index] then
        ...
        widget.export:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\export", {15, 15}, {"CENTER", 0, 0})
        ...
        widget.import:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\import", {15, 15}, {"CENTER", 0, 0})
        ...
        widget.clear:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\trash", {15, 15}, {"CENTER", 0, 0})
...
local function CreateCleuAuraButtons(parent, auraTable, updateHeightFunc)
    ...
    if not parent.inputs then
        ...
        spellEB.tip = spellEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
        ...
        durationEB.tip = durationEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    if not cleuAuraButtons[0] then
        ...
        cleuAuraButtons[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
    ...
    for i, t in ipairs(auraTable) do
        ...
        if not cleuAuraButtons[i] then
            ...
            cleuAuraButtons[i].del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
            ...
            cleuAuraButtons[i].edit:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\info", {16, 16}, {"CENTER", 0, 0})
...
local function CreateClassFrames(parent, builtIns, disableds)
    ...
    for _, class in pairs(classOrder) do
        if not classFrames[class] then
            ...
            classFrames[class].text = classFrames[class]:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateActionPreview(parent, style)
    ...
    local text = f:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateActionButtons(parent, spellTable, updateHeightFunc)
    ...
    if not actionButtons[0] then
        ...
        actionButtons[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
    ...
    for i, spell in ipairs(spellTable) do
        ...
        if not actionButtons[i] then
            ...
            actionButtons[i].del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
            ...
            actionButtons[i].edit:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\info", {16, 16}, {"CENTER", 0, 0})
...
local function CreateThresholdButtons(parent, thresholdTable, updateHeightFunc)
    ...
    if not thresholdButtons[0] then
        ...
        thresholdButtons[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
    ...
    for i, t in ipairs(thresholdTable) do
        ...
        if not thresholdButtons[i] then
            ...
            thresholdButtons[i].del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
...
local function CreateSetting_HighlightType(parent)
    ...
    if not settingWidgets["highlightType"] then
        ...
        --[[
        -- curse
        widget.curseCP = Cell.CreateColorPicker(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Curse:0|t "..L["Curse"], false, nil, function(r, g, b)
        ...
        -- disease
        widget.diseaseCP = Cell.CreateColorPicker(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Disease:0|t "..L["Disease"], false, nil, function(r, g, b)
        ...
        -- magic
        widget.magicCP = Cell.CreateColorPicker(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Magic:0|t "..L["Magic"], false, nil, function(r, g, b)
        ...
        -- poison
        widget.poisonCP = Cell.CreateColorPicker(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Poison:0|t "..L["Poison"], false, nil, function(r, g, b)
...
local function CreateSetting_Shape(parent)
    ...
    if not settingWidgets["shape"] then
        ...
        for i, s in pairs(shapes) do
            ...
            widget.buttons[s]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Shapes\\"..shapes[i].."_filled", {18, 18}, {"CENTER", 0, 0})
        ...
        --     {
        --         ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Shapes\\circle_filled:0|t",
        --         ["value"] = "circle",
        --         ["onClick"] = function()
        --             widget.func("circle")
        --         end,
        --     },
        --     {
        --         ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Shapes\\square_filled:0|t",
        --         ["value"] = "square",
        --         ["onClick"] = function()
        --             widget.func("square")
        --         end,
        --     },
        --     {
        --         ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Shapes\\rhombus_filled:0|t",
        --         ["value"] = "rhombus",
        --         ["onClick"] = function()
        --             widget.func("rhombus")
        --         end,
        --     },
        --     {
        --         ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Shapes\\hexagon_filled:0|t",
        --         ["value"] = "hexagon",
        --         ["onClick"] = function()
        --             widget.func("hexagon")
        --         end,
        --     },
        --     {
        --         ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Shapes\\octagon_filled:0|t",
        --         ["value"] = "octagon",
        --         ["onClick"] = function()
        --             widget.func("octagon")
        --         end,
        --     },
        --     {
        --         ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Shapes\\star_filled:0|t",
        --         ["value"] = "star",
        --         ["onClick"] = function()
        --             widget.func("star")
        --         end,
...
local function CreateSetting_DispelFilters(parent)
    ...
    if not settingWidgets["dispelFilters"] then
        ...
        widget.curse = Cell.CreateCheckButton(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Curse:0|t"..L["Curse"])
        widget.curse:SetPoint("TOPLEFT", widget.dispellableByMe, "BOTTOMLEFT", 0, -8)

        widget.disease = Cell.CreateCheckButton(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Disease:0|t"..L["Disease"])
        widget.disease:SetPoint("TOPLEFT", widget.curse, 135, 0)

        widget.magic = Cell.CreateCheckButton(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Magic:0|t"..L["Magic"])
        widget.magic:SetPoint("TOPLEFT", widget.curse, "BOTTOMLEFT", 0, -8)

        widget.poison = Cell.CreateCheckButton(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Poison:0|t"..L["Poison"])
        widget.poison:SetPoint("TOPLEFT", widget.magic, 135, 0)

        widget.bleed = Cell.CreateCheckButton(widget, "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Bleed:0|t"..L["Bleed"])
...
local function CreateSetting_IconStyle(parent)
    ...
    if not settingWidgets["iconStyle"] then
        ...
        do
            ...
            -- blizzard
            local blizzard = ""
            local blizzard_icon = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\%s:0|t"

            -- rhombus
            local rhombus = ""
            local rhombus_icon = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Rhombus:0:0:0:0:16:16:0:16:0:16:%s:%s:%s|t"
