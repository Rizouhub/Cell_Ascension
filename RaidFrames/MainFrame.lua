...
Cell.Polyfill.HookScript(options, "OnEnter", function()
...
Cell.Polyfill.HookScript(options, "OnLeave", function()
    CellTooltip:Hide()
end)
...
Cell.Polyfill.SetColorTexture(mark.texture, 1, 0, 0, 0.4)
...
-- memUsage.text = memUsage:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    for class in F.IterateClasses() do
        if Cell.vars.raidSetup[role][class] then
            ...
            for i = 1, Cell.vars.raidSetup[role][class] do
                if line ~= "  " then
                    line = line .. "|TInterface\\AddOns\\Cell_Ascension\\Media\\white:10:1:0:0:1:10:1:1:1:10:0:0:0|t"
                end

                line = line .. "|TInterface\\AddOns\\Cell_Ascension\\Media\\white:10:2:0:0:2:10:1:2:1:10:"..r..":"..g..":"..b.."|t"
            end
        end
    end
...
Cell.Polyfill.HookScript(raid, "OnEnter", function()
...
Cell.Polyfill.HookScript(raid, "OnLeave", function()
    CellTooltip:Hide()
end)
