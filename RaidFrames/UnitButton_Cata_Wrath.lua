...
local function UnitButton_OnEvent(self, event, unit, ...)
    ...
    if type(unit) == "string" and (self.states.displayedUnit == unit or self.states.unit == unit or (self.states.displayedUnit and UnitIsUnit(unit, self.states.displayedUnit))) then
...
function CellUnitButton_OnLoad(button)
    ...
    shieldBar:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\shield.tga", "REPEAT", "REPEAT")
    ...
    overShieldGlow:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\overshield")
    overShieldGlow:Hide()
    ...
    overShieldGlowR:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\overshield_reversed")
    ...
    overAbsorbGlow:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\overabsorb")
    ...
    absorbsBar:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\shield.tga", "REPEAT", "REPEAT")
