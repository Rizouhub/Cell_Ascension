...
local function CreatePlaceHolder(index)
    ...
    placeholder.text = placeholder:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local dumbFS2 = menu:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
