...
local function CreateSRPane()
    ...
    local srTips = srPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    srReplyCastEB.tip = srReplyCastEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    srResponseText = srPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    srTimeoutText = srPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    srSpellsText = srPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    srMacroText = srPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    srMacroText:SetPoint("BOTTOMLEFT", srMacroEB, "TOPLEFT", 0, 1)
    srMacroText:SetText(L["Macro"])

    srMacroEB.gauge = srMacroEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    srTypeText = srPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateSpellEditFrame()
    ...
    -- title
    title = spellEditFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET_TITLE")
    ...
    spellIdEB.tip = spellIdEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    buffIdEB.tip = buffIdEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
