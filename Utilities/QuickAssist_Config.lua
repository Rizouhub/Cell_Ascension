...
local function UpdateLayoutPreview()
    if not layoutPreviewFrame then
        ...
        for i = 1, 40 do
            ...
            layoutPreviewButtons[i].text = layoutPreviewButtons[i]:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateQuickAssistPane()
    ...
    local qaTips = qaPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    export:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\export", {15, 15}, {"CENTER", 0, 0})
    ...
    import:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\import", {15, 15}, {"CENTER", 0, 0})
...
local function CreatePlayerList(parent, box)
    ...
    for i = 1, 40 do
        ...
        players[i].index:SetFont("Interface\\AddOns\\Cell_Ascension\\Media\\Fonts\\Accidental_Presidency.ttf", 12)
...
local function CreateLayoutPane()
    ...
    filterResetTips = filterPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateAutoSwitchFrame()
    ...
    asterisk = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
    asterisk:SetText("*")
    ...
    raidText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    mythicText = autoSwitchPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateNameWidth(parent)
    ...
    lengthEB.text = lengthEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    lengthEB2.text = lengthEB2:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateMyBuffWidget(parent, index)
    ...
    b:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {16, 16}, {"LEFT", 2, 0})
    ...
    b:SetScript("OnClick", function(self, button)
        if button == "LeftButton" then
            ...
            b.icon = nil
            b:SetText("")
            b.tex:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create")
...
local function CreateSpellsPane()
    ...
    local buffTrackerText = pages.spell:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local offensivesTrackerText = pages.spell:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    buffsAddBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {20, 20}, {"CENTER", 0, 0})
    ...
    castsAddBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {20, 20}, {"CENTER", 0, 0})
    ...
    -- tips ------------------------------------------------------------------ --
    local tip1 = pages.spell:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
