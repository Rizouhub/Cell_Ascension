...
local function CreateWidgets()
    ...
    modeBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\instant", {13, 13}, {"LEFT", 4, 0})
...
local function CreateProcessingFrame()
    ...
    -- progress bar
    progressBar = Cell.CreateStatusBar(nil, processingFrame, 1, 1, 100, true, nil, true, "Interface\\AddOns\\Cell_Ascension\\Media\\statusbar", Cell.GetAccentColorTable())
    progressBar:SetPoint("TOPLEFT", 10, -103)
    progressBar:SetPoint("BOTTOMRIGHT", -10, 102)

    -- combat tips
    combatTips = processingFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateRaidRosterGrid(parent, index)
    ...
    local nameText = grid:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateRaidRosterGroup(parent, groupIndex)
    ...
    local headerText = group:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
