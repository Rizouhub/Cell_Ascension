...
local function CreateRTPane()
    ...
    styleDropdown:SetItems({
        ...
        {
            ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\ready:14|t / |TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\pull:14|t A",
            ["value"] = "icon_button_h",
            ["onClick"] = function()
        ...
        {
            ["text"] = "|TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\ready:14|t / |TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\pull:14|t B",
            ["value"] = "icon_button_v",
            ["onClick"] = function()
