...
-- bar
--------------------------------------------------
local bar = Cell.CreateStatusBar("CellBattleResBar", battleResFrame, 10, 4, 100, false, nil, false, "Interface\\AddOns\\Cell_Ascension\\Media\\statusbar", Cell.GetAccentColorTable())
...
-- texts
--------------------------------------------------
local title = battleResFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
local stack = battleResFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
local rTime = battleResFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
local dummy = battleResFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET") -- used for updating width of battleResFrame
dummy:Hide()
...
battleResMover.text = battleResMover:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
