...
local function CreateDRPane()
    ...
    local drTips = drPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    drResponseText = drPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    drTimeoutText = drPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    drMacroEB.gauge = drMacroEB:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    drMacroText = drPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    debuffItems[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
    ...
    drDebuffsText = drPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    drTypeText = drPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
LoadList = function(scrollToBottom)
    ...
    for i, id in ipairs(CellDB["dispelRequest"]["debuffs"]) do
        if not debuffItems[i] then
            ...
            -- spellId text
            debuffItems[i].spellIdText = debuffItems[i]:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
            ...
            -- spellName text
            debuffItems[i].spellNameText = debuffItems[i]:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
            ...
            debuffItems[i].del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
