...
local function CreateQCPane()
    ...
    local qcTips = qcPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    qcNameText = qcPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    qcOrientationText = qcPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    -- tips -------------------------------------------------------------------------
    local tips = qcPane:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreateOuterPane()
    ...
    tip:SetSize(16, 16)
    tip:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\left-click")
...
local function CreateInnerPane()
    ...
    tip:SetSize(16, 16)
    tip:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\right-click")
...
local function CreateGlowBuffsPane()
    ...
    qcGlowBuffsAddBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {16, 16}, {"CENTER", 0, 0})
...
local function CreateGlowCastsPane()
    ...
    qcGlowCastsAddBtn:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {16, 16}, {"CENTER", 0, 0})
...
targetFrame.label = targetFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
...
local function CreatePreviewButton(b)
    ...
    p.s = p:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS_TITLE")
    p.s:SetPoint("CENTER")
...
CreateQuickCastButton = function(parent, name, isPreview)
    ...
    invalidTex:Hide()
    invalidTex:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\close")
