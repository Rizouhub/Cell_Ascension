...
local function Dispels_SetDispel_Blizzard(self, dispelType)
    self:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\"..dispelType)
    self:Show()
end

local function Dispels_SetDispel_Rhombus(self, dispelType)
    self:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Debuffs\\Rhombus")
...
-- name text
-------------------------------------------------
local font_name = CreateFont("Cell_Ascension_FONT_NAME")
...
local font_status = CreateFont("Cell_Ascension_FONT_STATUS")
...
function I.CreateNameText(parent)
    ...
    nameText.name = nameText:CreateFontString(parent:GetName().."NameText_Name", "OVERLAY", "Cell_Ascension_FONT_NAME")

    nameText.vehicle = nameText:CreateFontString(parent:GetName().."NameText_Vehicle", "OVERLAY", "Cell_Ascension_FONT_STATUS")
            ...
            if nameText.isPreview then
                ...
                if IsInRaid() and nameText.showGroupNumber then
                    ...
                    if raidIndex then
                        ...
                        -- nameText.name:SetText("|TInterface\\AddOns\\Cell_Ascension\\Media\\Icons\\group"..subgroup..":0:0:0:-1:64:64:6:58:6:58|t"..nameText.name:GetText())
...
function I.CreateStatusText(parent)
    ...
    local timer = statusText:CreateFontString(nil, "ARTWORK", "Cell_Ascension_FONT_STATUS")
...
function I.CreateHealthText(parent)
    ...
    local text = healthText:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
...
function I.CreatePowerText(parent)
    ...
    local text = powerText:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
    powerText.text = text
...
-- role icon
-------------------------------------------------
local ICON_PATH = "Interface\\AddOns\\Cell_Ascension\\Media\\Roles\\"
...
local READY_CHECK_STATUS = {
    ready = {t = "Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\readycheck-ready", c = {0, 1, 0, 1}},
    waiting = {t = "Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\readycheck-waiting", c = {1, 1, 0, 1}},
    notready = {t = "Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\readycheck-notready", c = {1, 0, 0, 1}},
}
