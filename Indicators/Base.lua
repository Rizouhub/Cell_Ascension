...
function I.CreateAura_BorderIcon(name, parent, borderSize)
    ...
    frame.stack = iconFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
    frame.duration = iconFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
...
function I.CreateAura_BarIcon(name, parent)
    ...
    frame.stack = frame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
    frame.duration = frame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
...
function I.CreateAura_Text(name, parent)
    ...
    local text = frame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
    frame.text = text
...
function I.CreateAura_Bar(name, parent)
    ...
    bar.stack = bar:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
    bar.duration = bar:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
...
function I.CreateAura_Block(name, parent)
    ...
    frame.stack = frame.cooldown:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
    frame.duration = frame.cooldown:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_STATUS")
